...
public class CatalogMenu {
    ...
    public static final ComponentTexture SCREEN_INVENTORY_CHROME = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(0, 0), new Vec2i(174, 164));
    public static final ComponentTexture SCREEN_INTERFACE_CHROME = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(0, 166), new Vec2i(252, 64));

    public static final ComponentTexture ACTIVATE_READY = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(0, 0), new Vec2i(0, 0));
    public static final ComponentTexture ACTIVATE_RESTING = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(0, 0), new Vec2i(0, 0));

    public static final ComponentTexture TOGGLE_ON = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(176, 54), new Vec2i(12, 5));
    public static final ComponentTexture TOGGLE_OFF = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(176, 61), new Vec2i(12, 5));

    public static final ComponentTexture MENU_SLOT = TEXTURE_ATLAS_MENUS_POUCH.getComponent(new Vec2i(192, 54), new Vec2i(18, 18));
