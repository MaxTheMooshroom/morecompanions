...
@Mod(companionpouch.MOD_ID)
public class companionpouch {
    public static final String MOD_ID = "companionpouch"; // <-- set to your real mod id


    public companionpouch() {
...
// Client-only ticking key watcher registered on client dist
    ...
    private static class ClientOnly {
        static void init() { net.qiyanamark.companionpouch.util.CompanionModifierUtil.registerClientKeyWatcher(); }
    }
}